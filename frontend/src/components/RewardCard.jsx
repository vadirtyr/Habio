    ...
    <div className="nb-card nb-card-hover p-5 flex flex-col" data-testid={`reward-card-${id}`}>
      <div className="flex items-start justify-between gap-2 mb-3">
        ...
        <div className="flex gap-1">
          ...
          <button onClick={() => onDelete(id)} className="w-8 h-8 rounded-lg border-2 border-[#1E1E24] bg-white flex items-center justify-center hover:bg-[#EF476F] hover:text-white" data-testid={`reward-delete-${id}`} aria-label="Delete reward">
